# Generated by Django 5.2.4 on 2025-10-21 21:12
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Profile_addres',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='profile_addres', serialize=False, to=settings.AUTH_USER_MODEL)),
                ...
                ('reg_street', models.CharField(default='', max_length=50, validators=[personal_account.models.validate_no_english], verbose_name='Улица')),
                ...
                ('act_street', models.CharField(default='', max_length=50, validators=[personal_account.models.validate_no_english], verbose_name='Улица')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Обработка', 'Обработка'), ('Пайщик', 'Пайщик'), ('Должник', 'Должник'), ('В очереди', 'В очереди')], default='Обработка', max_length=25, verbose_name='Статус')),
